...
After publishing the custom rules to an OCI registry, you can configure a separate pipeline to use these rules. One way to do this is by using the [Group IaC Settings API](https://apidocs.snyk.io/?version=2023-05-29%7Ebeta#patch-/groups/-group_id-/settings/iac).
